...
use WebTheory\SortOrder\Facades\_Facade;
...
final class Launcher
{
    ...
    protected function aliasClasses(): Launcher
    {
        $aliases = [
    ...
    private function launchSortOrder(): Launcher
    {
        SortOrder::launch($this->extension);
